...
public class SparkWebApp {
	...
	private static String calculadoraPage(Request req, Response res) {
        String pageContent
                ...
                + "<h2><FONT COLOR='white'>Digite los numeros separados por comas en el siguiente cuadro:</FONT></h2>"
                + "<form action=\"/calcule\">"
	...
	private static String calcule(Request req, Response res) {
        ...
        answ = "<!DOCTYPE html>"
                ...
                + "<body bgcolor='black'>"
                	...
                	+ "<h1> <FONT COLOR='white'>" + "La Derivacion estandar de la lista de datos es: "+ derivacion +"</FONT><h1>"
                + "<form>"
